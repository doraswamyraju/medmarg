...
fun MedMargApp() {
    ...
    var currentLocation by remember { mutableStateOf("Indiranagar, Bangalore") }
    ...
    val cartItems = remember {
        mutableStateListOf(
            CartItem(
                ...
                subtitle = "8 Parameters • Free Home Collection",
        ...
        LocationPickerBottomSheet(
            ...
            onSelectAddress = { newAddress ->
                ...
                coroutineScope.launch {
                    snackbarHostState.showSnackbar("Serving address updated to: $newAddress")
                }
            }
        )
    }
